...
namespace craftersmine.Riot.Api.League.Matches.Timeline.FrameEvents
{
    ...
    public class GameEndFrameEvent : BaseTimelineFrameEvent
    {
        ...
        /// <summary>
        /// Gets a real world <see cref="DateTime"/> when <see cref="craftersmine.Riot.Api.League.Matches.Timeline.LeagueTimelineFrameEventType.GameEnd"/> event was created
        /// </summary>
